...
enum llm_tensor {
    ...
    LLM_TENSOR_KVA_INP_NORM,   // kva: late-layer KV approximation projector
    LLM_TENSOR_KVA_INP,
    LLM_TENSOR_KVA_OUT_NORM,
    LLM_TENSOR_KVA_BLK_ATTN_NORM,
    LLM_TENSOR_KVA_BLK_ATTN_QKV,
    LLM_TENSOR_KVA_BLK_ATTN_OUT,
    LLM_TENSOR_KVA_BLK_FFN_NORM,
    LLM_TENSOR_KVA_BLK_FFN_UP,
    LLM_TENSOR_KVA_BLK_FFN_GATE,
    LLM_TENSOR_KVA_BLK_FFN_DOWN,
    LLM_TENSOR_KVA_HEAD,
    LLM_TENSOR_KVA_RES,
    LLM_TENSOR_KVA_FINAL,
