...
static const std::map<llm_kv, const char *> LLM_KV_NAMES = {
    ...
    { LLM_KV_KVA_SPLIT,                              "%s.kva.split"                              },
    { LLM_KV_KVA_EMBD,                               "%s.kva.embd"                               },
    { LLM_KV_KVA_BLOCKS,                             "%s.kva.blocks"                             },
    { LLM_KV_KVA_HEADS,                              "%s.kva.heads"                              },
    { LLM_KV_KVA_FFN,                                "%s.kva.ffn"                                },
    { LLM_KV_KVA_ROPE_BASE,                          "%s.kva.rope_base"                          },
...
static const std::map<llm_tensor, const char *> LLM_TENSOR_NAMES = {
    ...
    { LLM_TENSOR_KVA_INP_NORM,                           "kva.inp_norm" },
    { LLM_TENSOR_KVA_INP,                                "kva.inp" },
    { LLM_TENSOR_KVA_OUT_NORM,                           "kva.out_norm" },
    { LLM_TENSOR_KVA_BLK_ATTN_NORM,                      "kva.blk.%d.attn_norm" },
    { LLM_TENSOR_KVA_BLK_ATTN_QKV,                       "kva.blk.%d.attn_qkv" },
    { LLM_TENSOR_KVA_BLK_ATTN_OUT,                       "kva.blk.%d.attn_out" },
    { LLM_TENSOR_KVA_BLK_FFN_NORM,                       "kva.blk.%d.ffn_norm" },
    { LLM_TENSOR_KVA_BLK_FFN_UP,                         "kva.blk.%d.ffn_up" },
    { LLM_TENSOR_KVA_BLK_FFN_GATE,                       "kva.blk.%d.ffn_gate" },
    { LLM_TENSOR_KVA_BLK_FFN_DOWN,                       "kva.blk.%d.ffn_down" },
    { LLM_TENSOR_KVA_HEAD,                               "kva.head.%d" },
    { LLM_TENSOR_KVA_RES,                                "kva.res.%d" },
    { LLM_TENSOR_KVA_FINAL,                              "kva.final" },
...
static const std::map<llm_tensor, llm_tensor_info> LLM_TENSOR_INFOS = {
    ...
    {LLM_TENSOR_KVA_INP_NORM,               {LLM_TENSOR_LAYER_REPEATING, GGML_OP_MUL}},
    {LLM_TENSOR_KVA_INP,                    {LLM_TENSOR_LAYER_REPEATING, GGML_OP_MUL_MAT}},
    {LLM_TENSOR_KVA_OUT_NORM,               {LLM_TENSOR_LAYER_REPEATING, GGML_OP_MUL}},
    {LLM_TENSOR_KVA_BLK_ATTN_NORM,          {LLM_TENSOR_LAYER_REPEATING, GGML_OP_MUL}},
    {LLM_TENSOR_KVA_BLK_ATTN_QKV,           {LLM_TENSOR_LAYER_REPEATING, GGML_OP_MUL_MAT}},
    {LLM_TENSOR_KVA_BLK_ATTN_OUT,           {LLM_TENSOR_LAYER_REPEATING, GGML_OP_MUL_MAT}},
    {LLM_TENSOR_KVA_BLK_FFN_NORM,           {LLM_TENSOR_LAYER_REPEATING, GGML_OP_MUL}},
    {LLM_TENSOR_KVA_BLK_FFN_UP,             {LLM_TENSOR_LAYER_REPEATING, GGML_OP_MUL_MAT}},
    {LLM_TENSOR_KVA_BLK_FFN_GATE,           {LLM_TENSOR_LAYER_REPEATING, GGML_OP_MUL_MAT}},
    {LLM_TENSOR_KVA_BLK_FFN_DOWN,           {LLM_TENSOR_LAYER_REPEATING, GGML_OP_MUL_MAT}},
    {LLM_TENSOR_KVA_HEAD,                   {LLM_TENSOR_LAYER_REPEATING, GGML_OP_MUL_MAT}},
    {LLM_TENSOR_KVA_RES,                    {LLM_TENSOR_LAYER_REPEATING, GGML_OP_MUL_MAT}},
    {LLM_TENSOR_KVA_FINAL,                  {LLM_TENSOR_LAYER_OUTPUT,    GGML_OP_MUL_MAT}},
